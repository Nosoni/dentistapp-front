...
const CobranzaBuscador = (props) => {
  ...
  const filtrarCobranza = async (filtro) => {
    validarPeticion(cobranzaFiltrar(token, filtro), (respuesta) => {
  ...
  const buscar = async (filtro) => {
    await reporte(token, filtro, 'cobranzas').then(response => {
...
export default CobranzaBuscador
